...
- [Transcription - started](/bubble/daily/plugin-reference/elements/daily-events#transcription): Fires for all participants when transcription starts.
- [Transcription - stopped](bubble/daily/plugin-reference/elements/daily-events#transcription): Fires for all participants when transcription stops.
- [Transcription - error](bubble/daily/plugin-reference/elements/daily-events#transcription): Emitted for all participants when there has been a transcription error.
