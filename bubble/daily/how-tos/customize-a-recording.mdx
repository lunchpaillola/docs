...
⚠️ **Note**: This feature is pay-as-you-go. You'll need to add your credit card details to your Daily account to enable it [here](https://dashboard.daily.co/billing). Customizations only apply to rooms with **cloud** recordings enabled.
