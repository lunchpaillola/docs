...
Sometimes, you want to add a custom button in Daily Prebuilt to trigger actions in your Bubble app, such as opening a new page, updating a database, or starting an app or transcription. This guide walks you through how to do it!

![Custom Buttons](https://res.cloudinary.com/dpfmaccxx/image/upload/v1727971153/customTrayButtons_pgy3ox.gif)

## Steps

### 1. Add the Daily Events element

Place the [**Daily Events**](/bubble/daily/plugin-reference/elements/daily-events) element on your page. A common practice is to place it inside a hidden popup, keeping it offscreen while it listens for events.
