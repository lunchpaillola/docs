...
### 1. Add the Daily PLUS Events element

Place the [**Daily PLUS Events**](/bubble/daily/plugin-reference/elements/daily-events) element on your page. A common practice is to place it inside a hidden popup, keeping it offscreen while it listens for events.
