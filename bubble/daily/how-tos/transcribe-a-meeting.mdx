...
Learn how to transcribe your meetings with this guide. This guide covers the auto-transcribe method, but you can also manually start transcription with the [**start transcription**](/bubble/daily/plugin-reference/actions/start-transcription) action while in a call. If you prefer a video walkthrough, check out our step-by-step tutorial below. Otherwise, keep reading for the written guide:
