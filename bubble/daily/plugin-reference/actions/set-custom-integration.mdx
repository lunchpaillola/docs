...
| **clearExisting**  | Boolean  | Set to `no` to clear existing integrations. Set to `yes` to keep existing integrations and add new ones. Useful when adding multiple integrations.                                                                                                                                                           |
