---
title: "Update Room"
description: "Use this action to set a room's privacy and config properties through Daily's API. Learn more about this API call at   Use this action to create a new room through Daily's API. Learn more about this API call at [Daily API Reference](https://docs.daily.co/reference#set-room-configuration)"
---
