---
title: "Use the presence element"
---

import liveblocksFooter from "/snippets/liveblocksFooter.mdx";

One of the first things you'll want to do after setting up Liveblocks in your app is likely to work with the [presence element](/bubble/liveblocks/plugin-reference/elements/liveblocks-presence). Presence allows you to track who's on a page, and you can use it to build features like:
...
- **Collaborative editing indicators**: Show when multiple users are viewing the same document or page.

## What we'll build

This tutorial covers how we set up presence in the demo app. For the exact setup from this tutorial, visit the [tutorial demo editor](https://bubble.io/page?id=lpl-liveblocks&tab=tabs-2&name=presence-tutorial&type=page), or [try the live demo](https://lpl-liveblocks.bubbleapps.io/version-test/live-cursors).
