...
| ------------------------------------------------------------------------------------------------------------------ | :--------------: | :--------------: |
| **Presence**: Instantly know who's online and track their activity in real-time.                                   |        ✅        |        ✅        |
| **Live Cursors**: See exactly where everyone is on the page in real-time.                                          |        ✅        |        ✅        |
| **Liveblocks Room Creation**: Create and manage rooms for real-time collaboration.                                 |        ✅        |        ✅        |
| **Broadcast Custom Events**: Send custom events to your rooms and trigger actions in Bubble based on those events. |        ❌        |        ✅        |
| **Comments**: Easily manage comments and threads to streamline team discussions and feedback.                      |        ❌        |  _coming soon_   |
| **Notifications**: Build in-app notifications for your collaborative products.                                     |        ❌        |  _coming soon_   |
| **Storage**: Edit interfaces in real-time with Liveblocks' advanced storage features.                              |        ❌        |  _coming soon_   |
